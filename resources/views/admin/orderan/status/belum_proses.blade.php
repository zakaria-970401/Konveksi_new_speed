      ...
      <div class="card-body">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <a href="/lihat_orderan/detail/{{$item->id}}" class="btn btn-primary btn-sm"><i class="fas fa-eye"> Detail</i></a>
            <a href="/orderan/mulai_produksi/{{$item->id}}" class="btn btn-outline-warning btn-sm "><i class="fas fa-dolly"> Mulai Produksi</i></a>
        </td>
            </tr>
