      ...
      <div class="card-body">
        <table class="table table-bordered table-hover">
          ...
          <td class="text-center">
            <a href="/lihat_orderan/detail/{{$item->id}}" class="btn btn-warning btn-sm"><i class="fas fa-eye"> Detail</i></a>
            <a href="/orderan/selesai_produksi/{{$item->id}}" class="btn btn-outline-info btn-sm "><i class="fas fa-clipboard-check"> Selesai Produksi</i></a>
          </td>
            </tr>
